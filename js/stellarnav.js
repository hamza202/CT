...
(function($) {
	$.fn.stellarNav = function(options, width, breakpoint) {
		...
		return this.each( function() {
			...
			nav.prepend('<a href="#" class="menu-toggle ' + cssClass + '"><i class="fa fa-bars"></i><div class="logo mobile-logo"><a href="index.html"><img src="images/logo.png" alt="Awesome Image"></a></div></a>');
