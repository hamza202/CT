...
<head>
    <meta charset="UTF-8">
    <title>CT professional service</title>
...
<div id="minimal-bootstrap-carousel" data-ride="carousel"
    ...
    <div role="listbox" class="carousel-inner">
        ...
        <div style="background-image: url(images/slider/1-2.jpg);background-position: center right;"
             class="item slide-2">
            <div class="carousel-caption">
                <div class="thm-container">
                    <div class="box valign-bottom">
        ...
        <div style="background-image: url(images/slider/1-3.jpg);background-position: center right;"
             class="item slide-3">
            <div class="carousel-caption">
                <div class="thm-container">
                    <div class="box valign-bottom">
...
<section class="note-bg">
    <div class="thm-container">
        <div class="row">
            <div class="col-md-4">
                <h2>We Provide, dealing with your finances can be intimide ...</h2>
            </div>
            <div class="col-md-8">
                <h3>That's why we take the time to listen to you, learn your goals and then create your plan using John
                    Doe’s philosophies that reflect .</h3>
...
<section class="sec-pad team-bg team-bg2">
    <div class="thm-container">
        ...
        <div class="add-feed-back pull-right">
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#feedBack">Add Feedback
