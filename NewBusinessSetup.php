...
<head>
    <meta charset="UTF-8">
    <title>CT || New Business Setup</title>
                    ...
                    <div class="bread-cumb">
                        <div class="thm-container">
                            <ul class="list-inline">
                                ...
                                <li><span>New Business Setup</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8 pull-right">
                <div class="left-box">
                    <div class="single-service-box ">
                        ...
                        <h3>Professional payroll services for both small businesses and corporations </h3>
                        <p>Payroll can be confusing and time-consuming. We can tailor our payroll services to fit your
                            small business. Let us</p>
