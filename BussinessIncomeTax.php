            ...
            <div class="col-md-8 pull-right">
                <div class="left-box">
                    <div class="single-service-box ">
                        ...
                        <!-- /.img-box-->
                        <div class="sec-title">
                            <h2>Business income tax</h2>
                            <div class="decor-line"></div>
                        </div>
                        <p>We prepare corporate tax returns and will assist you in understanding complex tax regulations
                            to help you make informed business decisions, which will help you minimize your corporate
                            taxes by taking advantage of the tax exemptions, credits and deferrals that may apply to
                            you. We will represent and/or assist you regarding taxation and audit issues with the
                            CRA.</p>
                        <div class=" faq-page mt-30">
                            <div id="accordion" role="tablist" class="panel-group accordion">
                                <div class="panel panel-default"><a role="button" data-toggle="collapse"
                                                                    ...
                                                                    class="collapsed" aria-expanded="false">REVENUE</a>
