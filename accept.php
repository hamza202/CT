    ...
    <div class="container">
        <div class="ad-profile section">
            ...
            <ul class="user-menu list-inline">
                ...
                <li class="active"><a href="accept.php">Accept</a></li>
                ...
                <div class="col-sm-12">
                    <div class="user-pro-section mb-50">
                        ...
                        <div style="margin-top:20px;">
                            <table class="text-capitalize table table-bordered table-hover table-striped table-foldersystem">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th>Title</th>
                                ...
                                <tr>
                                    ...
                                    <td>Hello</td>
                                    <td>Personal</td>
                                    <td><span class="ac-status">Active</span></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#myModal">Show Message
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>hamza</td>
                                    <td>Personal</td>
                                    <td><span class="End-status">End</span></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#myModal">Show Message
                                        </button>
